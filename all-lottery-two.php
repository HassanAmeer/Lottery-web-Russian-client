...
<div class="color-version-area">
  <a href="dark/all-lottery-two.php" class="dark-vesion">Dark</a>
...
?> 
              ...
              <div class="right text-right">
                <span class="draw-days">draw in <span class="rmndaysonly">
                  
                </span> days</span>
                <div class="header-btn-area">
                  <button type="button" id="quick-pick-all"> Pick ?</button>
                  <button type="button" id="add-item"><i class="fa fa-refresh"></i></button>
                ...
                <div class="play-card">
                  ...
                  <div class="play-card-inner text-center">
                    <div class="play-card-header">
                      ...
                      <div class="header-btn-area">
                        <button type="button" id="quick-pick1"> From Cards</button>
                        <button type="button" id="clear-pick1"> 7 </button>
                      </div>
                    </div>
                ...
                <div class="play-card">
                  ...
                  <div class="play-card-inner text-center">
                    <div class="play-card-header">
                      <span class="number-amount">Pick Lottery</span>
                      <div class="header-btn-area">
                        <button type="button" id="quick-pick2">From Card</button>
                        <button type="button" id="clear-pick2"> 20 </button>
                      </div>
                    </div>
                    <div class="play-card-body">
                      <ul class="number-list">
                ...
                <div class="play-card">
                  ...
                  <div class="play-card-inner text-center">
                    <div class="play-card-header">
                      <span class="number-amount">Pick Lottery</span>
                      <div class="header-btn-area">
                        <button type="button" id="quick-pick3"> From Card</button>
                        <button type="button" id="clear-pick3"> 18 </button>
                      </div>
                    </div>
                    <div class="play-card-body">
                      <ul class="number-list">
                ...
                <div class="play-card">
                  ...
                  <div class="play-card-inner text-center">
                    <div class="play-card-header">
                      <span class="number-amount">Pick Lottery</span>
                      <div class="header-btn-area">
                        <button type="button" id="quick-pick4">From Card</button>
                        <button type="button" id="clear-pick4"> 07 </button>
                      </div>
                    </div>
                    <div class="play-card-body">
                      <ul class="number-list">
                ...
                <div class="play-card">
                  ...
                  <div class="play-card-inner text-center">
                    <div class="play-card-header">
                      <span class="number-amount">Pick Lottery</span>
                      <div class="header-btn-area">
                        <button type="button" id="quick-pick5"> From Card</button>
                        <button type="button" id="clear-pick5"> 02 </button>
                      </div>
                    </div>
                    <div class="play-card-body">
                      <ul class="number-list">
   ...
   <div class="progress">
     <div class="progress-bar">70%</div>
              ...
              <div class="right d-flex justify-content-between">
                <div class="content">
                  <p>
                    <span>2 draw with 2 ticket:</span>
                    <span class="amount"> 1000 <i class="fa fa-ruble text-primary"> </i> of 1 ticket </span>
                  </p>
                  <p>
      ...
      <div class="row m-bottom-not-30">
        <div class="col-lg-4 col-md-6">
          <div class="overview-item text-center">
            <div class="icon"><img src="assets/images/svg-icons/overview-icons/1.svg" alt="icon"></div>
            <div class="content">
              ...
              <a href="login.php">Go to Results page</a>
            </div>
          </div>
        </div><!-- overview-item end -->
        <div class="col-lg-4 col-md-6">
          <div class="overview-item text-center">
            <div class="icon"><img src="assets/images/svg-icons/overview-icons/2.svg" alt="icon"></div>
            <div class="content">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="overview-item text-center">
            <div class="icon"><img src="assets/images/svg-icons/overview-icons/3.svg" alt="icon"></div>
            <div class="content">
