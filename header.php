...
new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: "ru,en", selectedLanguages:"ru"}, 'google_translate_element');
}
// ]]></script>
...
<div class="main-light-version">
  ...
  <header class="header-section">
    <div class="header-top">
      ...
      <a href="tel:<? echo $vfallstngf['phone1'];  ?>"><i class="fa fa-headphones"></i>Support</a>
                        </div>
                        <div class="email-part">
   <a href="mailto:<? echo $vfallstngf['email'];  ?>"><i class="fa fa-envelope"></i><span class="__cf_email__" data-cfemail=""> send Mail </span></a>
                        </div>
                    </div>
                </div>
        ...
        <nav class="navbar navbar-expand-xl">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu ml-auto">
              ...
              <li><a href="lottery-result.php">results</a>
