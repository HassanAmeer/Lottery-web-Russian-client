...
<div class="color-version-area">
  <a href="dark/home.php" class="dark-vesion">Dark</a>
  <a href="home.php" class="light-vesion">Light</a>
</div>
</div>


<div style="width: 86%; margin-left: 7%; margin-right: 7%;box-shadow: 1px 1px 20px silver; border-radius: 0 0 20px 20px; background: skyblue; border-radius: 0 0 30px 30px;">

<div style="background-image: url('assets/images/inner-page-bg.jpg'); width:100%; box-shadow: 1px 1px 30px rgb(163, 163, 163); border-radius: 0 0 20px 20px; position: relative; z-index:50;">
...
<div class="" style="display:flex; flex-direction: row;">
  ...
  ;" >
     ...
     <a href="profile.php" style="text-decoration:decoration;" class="btn text-btn"> View Profile </a>
  </div>
...
<div style="width:90%; margin-left:5%; margin-right:5%; display:flex; flex-direction:row;vertical-align: center;">
 ...
 <marquee id="soutmarquee">
  <small style="color: white;letter-spacing: 4px; text-shadow:1px 1px 2px black;"> <? echo $chkq['bells']; ?></small> <i class="fa fa-gift" style="color:skyblue;text-shadow:1px 1px 2px navy;"> </i>
 </marquee>
 </div>
 </div>
...
<div style="display:non;text-align:center; justify-content:center;">
<center>
  <b class="whentimendvtxt" style="color:green; display:none;"> Time To Draw Lottery Tickets </b>
  <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_h7q0t9pm.json" style="width:60%; margin-left:20%;margin-right:20%;height:12rem;overflow:hidden; position:absolute;z-index:50;margin-top:-5rem;" background="transparent" speed="1" loop autoplay></lottie-player>
</center>
    <!---------------------------------->
</div>
