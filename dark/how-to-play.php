...
<body>
  ...
  <!-- preloader end -->
        ...
        <div class="template-version">
          ...
          <div class="color-version-area">
            <a href="how-to-play.php" class="dark-vesion">Dark</a>
  ...
  <div class="main-dark-version">
    ...
    <section class="reward-section section-padding border-top has_bg_image" data-background="assets/images/03.jpg">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-7">
            <div class="section-header text-center">
