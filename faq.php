  ...
  <!-- preloader end -->
        ...
        <div class="template-version">
          ...
          <div class="color-version-area">
            <a href="faq.php" class="dark-vesion">Dark</a>
            ...
            <div class="faq-wrapper">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                  <div class="accordion siteName-accordion" id="accordionExample">
                    <div class="card">
                ...
                <div class="tab-pane fade" id="banking" role="tabpanel" aria-labelledby="banking-tab">
                  <div class="accordion siteName-accordion" id="accordionExample2">
                    <div class="card">
                ...
                <div class="tab-pane fade" id="winning" role="tabpanel" aria-labelledby="winning-tab">
                  <div class="accordion siteName-accordion" id="accordionExample3">
                    <div class="card">
                ...
                <div class="tab-pane fade show active" id="results" role="tabpanel" aria-labelledby="results-tab">
                  <div class="accordion siteName-accordion" id="accordionExample4">
                    <div class="card">
                ...
                <div class="tab-pane fade" id="about" role="tabpanel" aria-labelledby="about-tab">
                  <div class="accordion siteName-accordion" id="accordionExample5">
                    <div class="card">
                ...
                <div class="tab-pane fade" id="general" role="tabpanel" aria-labelledby="general-tab">
                  <div class="accordion siteName-accordion" id="accordionExample6">
                    <div class="card">
