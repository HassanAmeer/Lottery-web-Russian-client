  ...
  <!-- preloader end -->
        ...
        <div class="template-version">
          ...
          <div class="color-version-area">
            <a href="affiliate.php" class="dark-vesion">Dark</a>
          ...
          <div class="col-lg-5">
            <div class="affiliate-content">
                ...
                <div class="content">
                  ...
                  <p>Payments are made monthly via payment methods PAYEER     .</p>
                </div>
            </div>
          </div>
          <div class="col-lg-6">
          ...
          <div class="col-lg-10">
            <div class="payment-method-area d-flex">
              <div class="payment-item">
                <a href="#0"><img style="width:30%;" src="assets/images/payment-methods/payeer.png" alt="payment-method-image"></a>
